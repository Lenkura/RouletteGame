...
public interface GameCallback
{
	 ...
	 *            the player removed
	 * 			
	 * @see ausroulette.model.GameEngine#removeCallback(GameCallback)
	 */
	...
	/**
	 * Updates the view when a bet is successfully cancelled the
	 * {@link ausroulette.model.GameEngine}
	 * 
	 * @param bet
	 *            the cancelled bet
	...
	/**
	 * Updates the view each intermediate tick the wheel during a spin in the
	 * {@link ausroulette.model.GameEngine}
	 * 
	 * @param spinNumber
	 *            the spin number (a counter)
	 ...
	 * {@link Bet}s at the conclusion of the in the
	 * {@link ausroulette.model.GameEngine}
	 * 
	 * @param spinNumber
	 *            the spin number (a counter)
	 ...
	 * of the in the {@link ausroulette.model.GameEngine}
	 * 
	 * @param spinNumber
	 *            the spin number (a counter)
